...
document.getElementById('jump').addEventListener('mousedown', ev => onkey(ev, KEY.SPACE, true), false);
document.getElementById('jump').addEventListener('mouseup', ev => onkey(ev, KEY.SPACE, false), false);
...
document.getElementById('jump').addEventListener('touchstart', ev => onkey(ev, KEY.SPACE, true), false);
document.getElementById('jump').addEventListener('touchend', ev => onkey(ev, KEY.SPACE, false), false);
